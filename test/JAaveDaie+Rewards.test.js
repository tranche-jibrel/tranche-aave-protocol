...
contract("JAave DAI.e & rewards", function (accounts) {
  ...
  it("user1 buys some token daiTrA", async function () {
    trAddresses = await jAaveContract.trancheAddresses(1);
    ...
    console.log("avDAI_Address DAI.e balance: " + fromWei(await daiContract.methods.balanceOf(avDAI_Address).call()) + " DAI.e");
    console.log("JAave DAI.e balance: " + fromWei(await daiContract.methods.balanceOf(jAaveContract.address).call()) + " DAI.e");
    console.log("JAave cDAI balance: " + fromWei(await jAaveContract.getTokenBalance(avDAI_Address)) + " qiDAI");
    trPar = await jAaveContract.trancheParameters(1);
  ...
  it("user1 buys some token daiTrB", async function () {
    ...
    console.log("CErc20 DAI.e balance: " + fromWei(await daiContract.methods.balanceOf(avDAI_Address).call()) + " DAI.e");
    console.log("JAave DAI.e balance: " + fromWei(await jAaveContract.getTokenBalance(avDAI_Address)) + " qiDAI");
  ...
  it("user1 redeems token daiTrA", async function () {
    ...
    console.log("JAave qiDAI balance: " + fromWei(await jAaveContract.getTokenBalance(avDAI_Address)) + " qiDAI");
    ...
    trPar = await jAaveContract.trancheParameters(1);
    console.log("TrA price: " + fromWei(trPar[2].toString()));
    await daiTrAContract.approve(jAaveContract.address, balTrB, {from: user1});
    tx = await jAaveContract.redeemTrancheAToken(1, balTrB, {from: user1});
    ...
    console.log("CErc20 DAI.e balance: " + fromWei(await daiContract.methods.balanceOf(avDAI_Address).call()) + " DAI.e");
    console.log("JAave new DAI.e balance: " + fromWei(await jAaveContract.getTokenBalance(avDAI_Address)) + " qiDAI");
    console.log("JAave TrA Value: " + fromWei(await jAaveContract.getTrAValue(1)));
    console.log("JAave total Value: " + fromWei(await jAaveContract.getTotalValue(1)));
